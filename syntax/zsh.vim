""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" This is syntax file for "zsh" scripts copied from instalation 
" of vim "8.1.5126"  on "Debian GNU/Linux 10 (buster)". For some
" reason syntax file from later versions of vim and nvim fail too
" execute folding. In this file, only one line was modified to
" disable folding of multiline comments outside of functions.
"
" Vim syntax file
...
syn region  zshComment          start='^\s*#' end='^\%(\s*#\)\@!'
                                ...
                                " \ contains=zshTodo,@Spell fold << ORIGINAL LINE

...
--
-- local nvim_share = vim.env.HOME .. "/.local/share/nvim"
local nvim_share = vim.fn.stdpath('data')

local node_path   = nvim_share .. "/node"
local cargo_path  = nvim_share .. "/cargo"
local python_path = nvim_share .. "/python"
local perl_path   = nvim_share .. "/perl5"
local lua_path    = nvim_share .. "/lua"
